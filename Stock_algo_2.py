#------------------------------------------------------
#
# NAME: 	Stock_algo_2.py
#
# PURPOSE:	Quantitative momentum strategy
#
# CREATED:	11.12.2021 - dserke
#
# SOURCE:	https://github.com/nickmccullum/algorithmic-trading-python/blob/master/finished_files/002_quantitative_momentum_strategy.ipynb
#
#------------------------------------------------------
